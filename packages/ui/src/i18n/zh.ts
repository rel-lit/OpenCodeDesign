...
export const dict = {
  ...
  "ui.tool.task": "任务",
  "ui.tool.designGraph": "设计图智能体",
  "ui.tool.designGraph.description": "分析设计图、生成变更提案并执行已批准的写入。",
  "ui.tool.designSearch": "设计搜索智能体",
  "ui.tool.designSearch.description": "搜索代码库并对比设计图摘要，返回摘要报告和差异分析。",
  "ui.tool.skill": "技能",
