export const dict = {
  ...
  "session.designApproval.title": "🧭 Design Change Direction",
  "session.designApproval.finalizeTitle": "🔒 Finalize Design Changes",
  "session.designApproval.optionRequired": "Please select an option",
  "session.designApproval.apply": "Apply",
  "session.designApproval.reject": "Reject",
  "session.designApproval.revise": "Revise",
  "session.designApproval.revisePlaceholder": "Describe what to revise…",
  "session.designApproval.reviseRequired": "Please enter revision notes",
