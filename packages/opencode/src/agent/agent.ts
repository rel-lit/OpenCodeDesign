    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Agent.state")(function* (ctx) {
        ...
        const defaults = Permission.fromConfig({
          ...
          design_withdraw_relation_prototype: "deny",
          design_list_buffer_operations: "deny",
          design_undo_buffer_operation: "deny",
          ...
          design_get_relation: "deny",
          design_get_prototype: "deny",
          design_expand_node_focused: "deny",
        ...
        const designChatPermissions = Permission.fromConfig({
          ...
          design_list_prototypes: "deny",
          design_update_prototype: "deny",
          design_delete_prototype: "deny",
        ...
        const designGraphPermissions = Permission.fromConfig({
          ...
          task: "deny",
          todowrite: "deny",
          design_ask_graph: "deny",
          design_request_change: "deny",
          design_summarize_design: "deny",
          design_search_project: "deny",
          design_search_web: "deny",
          design_get_temporary_working_set: "allow",
          design_expand_node: "allow",
          design_search_graph: "allow",
          design_get_state_summary: "allow",
          design_get_context: "allow",
          design_get_concept: "allow",
          design_get_relation: "allow",
          design_get_prototype: "allow",
          design_expand_node_focused: "allow",
          design_list_prototypes: "allow",
          design_define_context: "allow",
          design_update_context: "allow",
          design_withdraw_context: "allow",
          ...
          design_withdraw_relation_prototype: "allow",
          design_list_buffer_operations: "allow",
          design_undo_buffer_operation: "allow",
        ...
        const graphAgentInfo: Info = {
          ...
          mode: "subagent",
          native: true,
          permission: Permission.merge(defaults, designGraphPermissions, user),
          prompt: PROMPT_GRAPH,
          options: {},
        }
        ...
        design: {
          ...
          options: {},
          permission: Permission.merge(defaults, designChatPermissions, user),
          mode: "primary",
          native: true,
