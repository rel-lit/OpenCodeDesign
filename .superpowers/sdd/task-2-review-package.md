...
`
faf3cf234 refactor(design): extract WorkingSet factory
`

## Stat

`
 packages/opencode/src/design/core/working-set.ts | 232 ++++++++++++-----------
...
`diff
diff --git a/packages/opencode/src/design/core/working-set.ts b/packages/opencode/src/design/core/working-set.ts
index c644ff32e..f22d4433d 100644
--- a/packages/opencode/src/design/core/working-set.ts
+++ b/packages/opencode/src/design/core/working-set.ts
@@ -12,147 +12,151 @@ export interface Interface {
